# The name of this view in Looker is "Delta Lkp Conceptos Valoracion"
view: delta_lkp_conceptos_valoracion {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ntt-data-argentina-macro.Valoracion_Clientes.delta_LKP_Conceptos_Valoracion`
    ;;
